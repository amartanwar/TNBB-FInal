...
public class LeaseNonAccrualAndAccrualScript_E2E extends BaseTest {
	
	
	public void leasenonaccrualandaccrualscript(WebDriver driver, ExtentTest test, Map<String, String> map, int i) throws InterruptedException
	{
		
		LeaseMenuPage leasemenupage = new LeaseMenuPage(driver, test);
		
		
		if(Integer.parseInt(map.get("Is Non-Accrual"+i))==0)
		{

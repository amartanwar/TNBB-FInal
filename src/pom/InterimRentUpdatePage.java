...
public class InterimRentUpdatePage extends BasePage {

	
	public InterimRentUpdatePage(WebDriver driver,ExtentTest test)
	{
		super(driver,test);
	...
	@FindBy(id="ctl00_FC_PH_hlkPaymentReversal")
	private WebElement paymentReversalLink;
	...
	public void clickOnPaymentReversalLink()
	{
		WebDriverWait wt=new WebDriverWait(driver, 15);
		wt.until(ExpectedConditions.elementToBeClickable(paymentReversalLink));
		paymentReversalLink.click();

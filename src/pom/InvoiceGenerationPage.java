...
public class InvoiceGenerationPage extends BasePage
{
	...
	@FindBy(id="ctl00_F_PH_ReceivableTypeGridUC_grdLists_lnkAllCP")
	...
	public void selectReveivableRollupType()
	{
		WebDriverWait wt= new WebDriverWait(driver, 60);
		wt.until(ExpectedConditions.visibilityOf(receivables));
		receivables.click();
	}
